...
description: "With AI browsers like ChatGPT Atlas and Arc AI going mainstream, we're launching WCP to solve the 40-60% failure rate in AI-web interactions. Learn how one simple attribute can transform your site for AI agents."
author: "Umbrella Mode Team"
date: "December 2024"
tags: ["AI agents", "web standards", "protocols", "launch", "ChatGPT Atlas", "Arc AI"]
og:image: "/images/hero-light.png"
---

# Launching WCP: The Missing Layer Between AI and the Web

The AI browser revolution is here. ChatGPT Atlas can browse the web and complete complex tasks. Arc AI understands your browsing patterns. Browser Use enables autonomous web automation. But there's a critical problem: **AI agents are failing 40-60% of the time** when interacting with websites.
...
2024 marked a turning point for AI-web interaction:

<CardGroup cols={3}>
  <Card title="ChatGPT Atlas" icon="robot">
    OpenAI's AI browser that can navigate, search, and complete tasks across the web
  </Card>
  <Card title="Arc AI" icon="sparkles">
    The Browser Company's AI assistant that understands your browsing context
  </Card>
